...
const alias = 'lingualog';
const outputFile = 'release-keystore.jks';
const keyFile = 'lingualog-key.pem';
const certFile = 'lingualog-cert.pem';
const validityDays = '36500';
const subject = '/CN=LinguaLog/OU=Mobile/O=LinguaLog/C=IN';
...
try {
  ...
  console.log(`Verify: keytool -list -v -keystore ${outputFile} -storepass '<your-password>'`);
